...
public class DataReader {
	//public static String filename = "pageSpeedInput.xlsx";
	//public String path;
	public InputStream path = null;
	...
	public DataReader(InputStream path) {
...
/*	public int getColumnCount(String sheetName) {
	...
	public int getCellRowNum(String sheetName, String colName1, String cellValue1,String colName2, String cellValue2,int rowNum){
		
		for (int i = 2; i <= getRowCount(sheetName); i++) {
			if ((getCellData(sheetName, colName1, i).equalsIgnoreCase(cellValue1))&&(getCellData(sheetName, colName2, i).equalsIgnoreCase(cellValue2))&&(i>=rowNum)) {				
					return i;				
			}
		}		
